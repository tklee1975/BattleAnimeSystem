...
public partial class SimpleAnimation: MonoBehaviour
{
    ...
    public void AddClip(AnimationClip clip, string newName = "")
    {
        ...
        string name = newName != "" ? newName : clip.name;
    ...
    public void SetClip(AnimationClip clip, string name = "")
    {
        LegacyClipCheck(clip);
        Kick();
        //m_Playable.SetClip(clip, name);
        string animeName = name != "" ? name : clip.name;
        if (m_Playable.SetClip(clip, animeName))
        {
            RebuildStates();
        }
    }
